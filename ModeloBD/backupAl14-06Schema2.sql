...
INSERT INTO `alm_almacen` VALUES (1,'Direccion del almacen 1','111-1111',1,1),(2,'Direccion del almacen 2','222-2222',1,1),(3,'Direccion del almacen 3','333-3333',1,1),(4,'Direccion del almacen 4','444-4444',1,1),(5,'Direccion del almacen 5','555-5555',1,1),(6,'Calle del Nuevo Almacen 666','654-123',1,1);
...
INSERT INTO `alm_detalle_pedido_a_produccion` VALUES (1,7,3,30,''),(2,8,1,10,''),(3,8,3,10,''),(4,10,3,20,'Para ahora xd'),(5,11,1,2,'Pedido 1 de prueba'),(6,11,3,3,'Pedido 2 de prueba');
...
INSERT INTO `alm_ingresos_y_salidas` VALUES (1,1,0,1,1,'Prueba 2 General','2018-06-14','2018-06-14',1),(2,1,2,1,1,'','2018-06-14','2018-06-14',1),(3,1,2,1,1,'Prueba 3 General','2018-06-14','2018-06-14',1),(4,1,1,1,2,'Prueba 4 General','2018-06-14','2018-06-14',1);
...
INSERT INTO `alm_linea_ingreso` VALUES (1,2,1,10,''),(2,3,3,30,'Linea Prueba3'),(3,3,1,5,'Linea Prueba3');
...
INSERT INTO `alm_linea_salida` VALUES (1,4,1,15,'Salida Prueba 4'),(2,4,3,30,'Salida Prueba 4');
...
INSERT INTO `alm_pedido_a_produccion` VALUES (1,1,1),(2,1,1),(3,1,1),(4,1,1),(5,3,1),(6,3,1),(7,3,1),(8,1,1),(10,3,1),(11,1,1);
...
INSERT INTO `alm_producto_almacen` VALUES (1,1,15),(2,2,20),(2,3,25),(3,3,30),(4,8,40),(1,3,30),(6,1,60),(2,6,60),(6,2,60),(6,3,60),(6,8,60),(6,10,60);
...
INSERT INTO `alm_usuario_almacen` VALUES (1,5,1),(1,6,1),(1,13,1),(2,5,1),(2,7,1),(3,8,1),(4,9,1),(5,10,1);
...
INSERT INTO `prod_detalles_lista_produccion` VALUES (1,1,10,NULL,1),(1,3,30,NULL,1),(2,3,40,NULL,1),(3,1,10,NULL,1),(3,3,30,NULL,1);
...
INSERT INTO `prod_lista_pedidos` VALUES (1,7),(1,8),(2,7),(2,8),(3,7),(3,8);
...
INSERT INTO `prod_listas_de_produccion` VALUES (1,1,1,1,'2018-06-14 10:35:28','2018-06-14 10:35:28',4,1),(2,1,2,2,'2018-06-14 10:40:07','2018-06-14 10:40:07',4,1),(3,1,3,3,'2018-06-14 11:29:28','2018-06-14 11:29:28',4,1);
...
INSERT INTO `prod_manivelas` VALUES (7,'34.24',1),(8,'8/5',1),(9,'13/5',1),(11,'5/13',1),(12,'7/8',1),(14,'15',1);
...
INSERT INTO `prov_insumo` VALUES (1,'ALUBL','Aluminio blando',NULL,3,'2018-06-13 15:59:58'),(2,'ALUDR','Aluminio duro',NULL,3,'2018-06-13 15:59:58'),(3,'ALUST','Aluminio estándar',NULL,3,'2018-06-13 15:59:58');
...
INSERT INTO `prov_insumo_proveedor` VALUES (3,11,1,NULL,NULL,'ACT',3,'2018-06-14 04:58:00'),(4,11,2,NULL,NULL,'ACT',3,'2018-06-14 04:58:00'),(5,11,3,NULL,NULL,'ACT',3,'2018-06-14 04:58:00'),(6,12,2,NULL,NULL,'ACT',3,'2018-06-14 05:45:01'),(7,12,3,NULL,NULL,'ACT',3,'2018-06-14 05:45:01'),(8,13,2,NULL,NULL,'ACT',3,'2018-06-14 07:03:57'),(9,13,3,NULL,NULL,'ACT',3,'2018-06-14 07:03:57');
...
INSERT INTO `prov_proveedor` VALUES (11,11,NULL,0,'ACT',3,'2018-06-14 04:58:00'),(12,12,NULL,0,'ACT',3,'2018-06-14 05:45:01'),(13,13,NULL,0,'ACT',3,'2018-06-14 07:03:57');
...
INSERT INTO `prov_proveedor_natural` VALUES (11,17,'10239943842','REG','3','2018-06-14 04:58:00'),(12,18,'10234453234','REG','3','2018-06-14 05:45:01'),(13,19,'10284432124','REG','3','2018-06-14 07:03:57');
...
INSERT INTO `seg_rol` VALUES (1,'Jefe de Ventas','JVEN','2018-05-30 20:35:42'),(2,'Jefe de Almacenes','JALM','2018-05-30 20:35:42'),(3,'Jefe de Producción','JPROD','2018-05-30 20:35:42'),(4,'Jefe de Compras Y Proveedores','JCPROV','2018-05-30 20:35:42'),(5,'Usuario de Almacen','UALM','2018-05-30 15:51:42'),(6,'Ejecutivo de Ventas','EVEN','2018-06-10 16:46:42');
...
INSERT INTO `seg_usuario_rol` VALUES (3,1,3,'ACT',NULL,'2018-05-30 20:41:42'),(4,2,3,'ACT',NULL,'2018-05-30 20:41:42'),(5,3,4,'ACT',NULL,'2018-05-30 20:41:42'),(6,4,2,'ACT',NULL,'2018-05-30 16:17:42'),(7,5,5,'ACT',NULL,'2018-05-30 17:36:42'),(8,6,3,'ACT',NULL,'2018-05-31 04:52:42'),(9,7,4,'ACT',NULL,'2018-05-31 04:52:42'),(10,8,5,'ACT',NULL,'2018-05-31 04:52:42'),(11,9,5,'ACT',NULL,'2018-05-31 04:52:42'),(12,10,5,'ACT',NULL,'2018-05-31 04:52:42'),(13,11,2,'ACT',NULL,'2018-05-31 10:57:02'),(14,12,1,'ACT',NULL,'2018-05-31 10:57:02'),(15,13,5,'ACT',NULL,'2018-05-31 12:54:02'),(16,14,6,'ACT',NULL,'2018-05-31 12:54:02');
...
INSERT INTO `ven_cliente` VALUES (1,1),(2,1);
...
INSERT INTO `ven_pedido_almacen` VALUES (1,3,'Registrado','2018-05-31','admin',1);
...
BEGIN
	update ven_ventas set es_activo=0 where id=_id_venta;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
in _id_concepto_descuento varchar(25),
in _fecha_registro datetime,
in _id_user_registro bigint,
in _es_activo bigint,
out _id_venta bigint)
BEGIN
	insert into ven_ventas(id_cliente, estado, descuento, id_concepto_descuento, fecha_registro, id_user_registro, es_activo)
	values(_id_cliente, _estado, _descuento , _id_concepto_descuento, _fecha_registro , _id_user_registro , _es_activo);
...
BEGIN
	update ven_cliente_juridico
    set RAZON_SOCIAL = _razon_social, RUC = _ruc, GIRO_NEGOCIO = _giro_negocio, DIRECCION = _direccion, TELEFONO = _telefono, CORREO = _correo, FECHA_REGISTRO = _fecha_registro, USUARIO_REGISTRO = _usuario_registro, ACTIVO = _activo
    where ID_CLIENTE = _id_cliente;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
BEGIN
	update ven_cliente
    set NOMBRE = _nombre, APELLIDO_P = _apellido_p, APELLIDO_M = _apellido_m, DNI = _dni, SEXO = _sexo, DIRECCION = _direccion, TELEFONO = _telefono, CORREO =  _correo, FECHA_REGISTRO = _fecha_registro, USUARIO_REGISTRO = _usuario_registro, ACTIVO = _activo
    where ID_CLIENTE = _id_cliente;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2018-06-14  3:16:46
