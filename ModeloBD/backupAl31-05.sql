...
INSERT INTO `alm_pedido_a_produccion` VALUES (1,1,1,10,1);
...
INSERT INTO `alm_producto_almacen` VALUES (1,1,11),(2,2,20),(2,3,25),(3,3,30),(4,8,40);
...
INSERT INTO `alm_usuario_almacen` VALUES (1,5,1),(1,6,1),(2,5,1),(2,7,1),(3,8,1),(4,9,1),(5,10,1);
...
INSERT INTO `seg_usuario_rol` VALUES (3,1,3,'ACT',NULL,'2018-05-30 20:41:42'),(4,2,3,'ACT',NULL,'2018-05-30 20:41:42'),(5,3,4,'ACT',NULL,'2018-05-30 20:41:42'),(6,4,2,'ACT',NULL,'2018-05-30 16:17:42'),(7,5,5,'ACT',NULL,'2018-05-30 17:36:42'),(8,6,5,'ACT',NULL,'2018-05-31 04:52:42'),(9,7,5,'ACT',NULL,'2018-05-31 04:52:42'),(10,8,5,'ACT',NULL,'2018-05-31 04:52:42'),(11,9,5,'ACT',NULL,'2018-05-31 04:52:42'),(12,10,5,'ACT',NULL,'2018-05-31 04:52:42');
...
BEGIN
	INSERT INTO alm_pedido_a_produccion
		(ID_ALMACEN,ID_PRODUCTO,CANTIDAD,ACTIVO)
	VALUES(_id_almacen,_id_producto,_cantidad,1);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `prov_registrar_proveedor_natural` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
DELIMITER ;;
CREATE DEFINER=`inf282g2`@`%` PROCEDURE `prov_registrar_proveedor_natural`(
    ...
    IN _numeroDoc varchar(25),
    IN _direccion varchar(200),
    IN _estado varchar(3),
    IN _idUserRegistro int(15),
    IN _numeroRuc varchar(11)
)
BEGIN
    INSERT INTO gen_persona
    (nombres, paterno, materno, sexo, email, celular, id_tipo_doc_identidad,
        numero_doc_identidad, direccion, estado, id_user_registro, fecha_registro)
    VALUES
    (_nombres, _paterno, _materno, _sexo, _email, _celular, _idTipoDoc,
        _numeroDoc, _direccion, _estado, _idUserRegistro, SYSDATE());
    SET _idPersona = last_insert_id();
    INSERT INTO prov_proveedor_natural
    (id_persona, ruc)
    VALUES
    (_idPersona, _numeroRuc);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2018-05-31  5:03:43
