...
--
-- Host: quilla.lab.inf.pucp.edu.pe    Database: a20151258
-- ------------------------------------------------------
...
INSERT INTO `ALM_SALIDA_PRODUCTO` VALUES (13,1,'2018-05-23 20:42:20',2,1,'MI PRIMER ENVIO');
...
DELIMITER ;;
CREATE DEFINER=`a20151258`@`%` PROCEDURE `ACTUALIZAR_STOCK`(
	_ID_ALMACEN  INT,
	_ID_PRODUCTO INT,
    _NUEVO_STOCK INT
)
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`a20151258`@`%` PROCEDURE `REGISTRAR_PRODUCTO_ALMACEN`(
	_ID_PRODUCTO INT,
    _ID_ALMACEN INT,
    _STOCK_INICIAL INT
)
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`a20151258`@`%` PROCEDURE `REGISTRAR_SALIDA_PRODUCTO_ALMACEN`(
	_ID_ALMACEN_ENVIA INT,
    _ID_LOCAL_DEST INT,
...
-- Dump completed on 2018-05-23 23:21:14
